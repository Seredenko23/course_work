...
import DifferentialTable from "../diffirentialTable/diffirentialTable";
import '../../css/table.css'
import './task4.css'

class Task4 extends PureComponent {
    constructor() {
        super()
        this.state = {
            data: [],
    ...
    changeSelect = (event) => {
        this.func = event.currentTarget.value === 'equation' ? calculateEquation : calculateDifferential
                    ...
                    { this.state.mode === 'table' ? (
                        ...
                        <>
                            <form className={'intervals'} onSubmit={this.formHandler}>
                                ...
                                <div className={'interval-wrapper'}>
                                    <label htmlFor={'step'}>Step</label>
                                    <select className={'intervals-input'}
                                            name={'type'}
                                            value={this.state.type}
                                            onChange={this.changeSelect}
                                    >
                                        <option value={'equation'}>y(x)</option>
                                        <option value={'differential'}>y'(x)</option>
                                    </select>
                                </div>
